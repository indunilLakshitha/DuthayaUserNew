<template>
  <BaseLayout page_default_back_link="/journey_ongoing">
    <div>
      <ion-row style="margin-left: 10px">
        <p style="font-size: 22px"><b>Journey #2135 Details</b> <br /></p>
      </ion-row>
    ...
    <ion-grid class="ion-padding">
      <ion-row>
        ...
        <p style="text-align: right; margin-left: 110px">
          <span style="font-size: 14px">
            <span
              style="
                font-size: 14px;
      ...
      <ion-row>
        <img
          src="@/components/confirm_journey/next_tast.svg"
          alt=""
          style="margin-right: 10px"
        />
        <p style="text-align: left">
        ...
        <p style="text-align: right; margin-left: 100px">
          <span style="font-size: 14px">
            <span
              style="
                font-size: 14px;
      ...
      <ion-row>
        <img
          src="@/components/confirm_journey/pending.svg"
          alt=""
          style="margin-right: 10px"
        />
        <p style="text-align: left">
    ...
    <ion-item-divider style="min-height: 2px !important"></ion-item-divider>
    <ion-grid class="ion-padding">
      <ion-row>
        <img
        ...
        <p style="text-align: left">
          ...
          <br />
          <span style="font-size: 16px; font-weight: 600">Dinesh Ruwantha</span>
          <br />
          <img
