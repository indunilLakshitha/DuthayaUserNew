<template>
  <BaseLayout page_default_back_link="/main-1">
    <div class="ion-padding">
      ...
      <ion-grid class="ion-padding">
        <ion-row>
          ...
          <ion-input value="51, School lane, Colombo 05"> </ion-input>
        </ion-row>
        <ion-row>
    ...
    <ion-grid style="background: #e5e5e5" class="ion-padding">
      <ion-item router-link="/saved_places">
        <img
          src="@/components/document_delivery/saved_places.svg"
          alt=""
          slot="start"
        />
        Saved Places
      ...
      <br />
      <ion-item router-link="/document_delivery_map">
        <img
          src="@/components/document_delivery/pick_from_map.svg"
          alt=""
          slot="start"
        />
        Pick From Map
